...
Diversas substâncias são empregadas com a intenção
de incrementar o desempenho esportivo de atletas de
alto nível. O chamado doping sanguíneo, por exemplo,
pela utilização da eritropoietina, é proibido pelas principais
...
Em um autódromo, os carros podem derrapar em
...
- A) A força é maior na colisão com a barreira de pneus, e
a energia dissipada é maior na colisão com a barreira
de blocos.
- B) A força é maior na colisão com a barreira de blocos, e
a energia dissipada é maior na colisão com a barreira
de pneus.
- C) A força é maior na colisão com a barreira de blocos, e
...
EM 2022
A penicilamina é um medicamento de uso oral
utilizado no tratamento de várias doenças. Esse
composto é excretado na urina, cujo pH se situa entre
5 e 7. A penicilamina, cuja fórmula estrutural plana está
apresentada, possui três grupos funcionais que podem
ser ionizados:
• carboxila: —COOH, cujo pKa é igual a 1,8;
• amino: —NH2, que pode ser convertido em
amínio (—NH3+, cujo pKa é igual a 7,9);
...
predominantemente encontrada na urina?
CH3 H
− −
A S C C COO
CH3 NH2
...
O protozoário Trypanosoma cruzi, causador da
...
m
que a velocidade do som na água é de 1 540 e no ar
m s
é de 340 .
s
L
...
Tempo (s) Tempo (s)
CN - 2° dia | Caderno 5 - AMARELO - 1ª Aplicação
...
2 608 4
3 575 3
4 CN - 2° dia | Caderno 5 - AMARELO - 1ª Aplicação
...
Bactérias fixa- −
Nitratos (NO3 )
doras de N2 nos Decompositores
nódulos de raízes (fungos e bactérias
de leguminosas aeróbicas e anaeróbicas) Bactérias
nitrificantes
Amonificação Nitrificação
Amônia e Amônio −
(NH3) (NH4+) Nitritos (NO2 )
Bactérias fixadoras
...
- E) fazer uma pequena distinção de cores em ambientes
iluminados.
...
De modo geral, a palavra “aromático” invoca associações agradáveis, como cheiro de café fresco ou de um pão doce de
...
CH3 H3C
OH O
Benzaldeído Salicilato de metila Anetol
(no óleo de amêndoas) (no óleo de gaultéria) (no óleo de anis)
O H
CH2
O
HO H
...
H3C
OH CH3
Vanilina Eugenol Cinamaldeído
(no óleo de baunilha) (no óleo de cravos) (no óleo de canela)
...
Os resultados de um ensaio clínico randomizado na Indonésia apontaram uma redução de 77% dos casos de
...
CN - 2° dia | Caderno 5 - AMARELO - 1ª Aplicação 5
...
A extinção de espécies é uma ameaça real que
...
- A) ocupam áreas de vegetação nativa e substituem
parcialmente a flora original.
- B) estimulam a competição por seus frutos entre animais
típicos da região e eliminam as espécies perdedoras.
- C) alteram os nichos e aumentam o número de
possibilidades de relações entre os seres vivos
daquele ambiente.
- D) apresentam alta taxa de reprodução e se mantêm
com um número de indivíduos superior à capacidade
suporte do ambiente.
- E) diminuem a relação de competição entre os
...
Em um dia de calor intenso, dois colegas estão
...
de água da mangueira na direção horizontal, a 1 m de
...
13,0 18,0 16,0 14,0 17,0
de sacarose (g L-1)
Concentração de
microrganismos 0,7 0,8 0,6 0,5 0,9
(mg L-1)
...
- D) purificar ácidos nucleicos virais, facilitando a ação da
enzima.
...
E
Tribologia é o estudo da interação entre duas
superfícies em contato, como desgaste e atrito, sendo
de extrema importância na avaliação de diferentes
produtos e de bens de consumo em geral. Para testar
a conformidade de uma muleta, realiza-se um ensaio
tribológico, pressionando-a verticalmente contra o piso

com uma força F, conforme ilustra a imagem, em que CM
representa o centro de massa da muleta.

F
CM

Mantendo-se a força F paralela à muleta, varia-se
lentamente o ângulo entre a muleta e a vertical, até o máximo
ângulo imediatamente anterior ao de escorregamento,
denominado ângulo crítico. Esse ângulo também pode ser
calculado a partir da identificação dos pontos
 de aplicação,

da direção e do sentido das forças peso P , normal N e

de atrito estático e .
O esquema que representa corretamente todas as forças
que atuam sobre a muleta quando ela atinge o ângulo
crítico é:

F
CM
...
em energia térmica transferida para a água, que apresenta
J g
calor específico de 4,2 e densidade de 1 000 .
g
C L
...
Machos Machos Fêmeas
controle expostos controle
à atrazina
...
- A) impedir a formação de trombos, típicos em alguns
casos de acidente vascular cerebral.
- B) tratar consequências da anemia profunda, em razão da
perda de grande volume de sangue.
- C) evitar a manifestação de urticárias, comumente
...
- B) Eles oscilariam aleatoriamente em torno de suas
órbitas elípticas originais.
- C) Eles se moveriam em direção ao centro do Buraco
Negro.
...
O físico Hans C. Oersted observou que um fio transportando corrente elétrica produz um campo magnético. A presença
...
B C S
Bússola
Considerando apenas o campo magnético por causa da corrente i, as respectivas configurações das bússolas nos
...
intimamente relacionado com a umidade da pele, que
seca apresenta resistência elétrica da ordem de 500 kΩ,
mas, se molhada, pode chegar a apenas 1 kΩ.
Apesar de incomum, é possível sofrer um acidente
utilizando baterias de 12 V. Considere que um indivíduo
com a pele molhada sofreu uma parada respiratória
ao tocar simultaneamente nos pontos A e B de uma
associação de duas dessas baterias.
...
problema.
- D) liberação imediata da proteína normal na região
ocular humana.
...
descontaminação emprega o íon persulfato (S2O82−), que
é convertido no radical •SO4− por minerais que contêm
...
EM 2022
Em 2017, foi inaugurado, no estado da Bahia, o
...
W
irradiância solar média é de 1 500 2 e que a eficiência
dos painéis é de 20%. m
...
explosão,
minerais
Cianetos produção de
fortes
Hipoclorito de sódio oxidante forte e
concentrados
produto tóxico
Reação enérgica,
Ácido nítrico
Matéria orgânica explosão e
concentrado
produto tóxico
...
m
aceleração da gravidade é igual a 10 2 e despreza
forças dissipativas. s
...
- A) proteção catódica, que utiliza um metal fortemente
redutor.
- B) uso de metais de sacrifício, que se oxidam no lugar
do ferro.
- C) passivação do ferro, que fica revestido pelo seu
próprio óxido.
- D) efeito de barreira, que impede o contato com o agente
oxidante.
- E) galvanização, que usa outros metais de menor
...
- B) rompimento da membrana celular com liberação do
citosol.
- C) aumento do vacúolo com diluição do pigmento no seu
interior.
- D) quebra da parede celular com extravasamento do
pigmento.
- E) murchamento da célula com expulsão do pigmento
do vacúolo.
...
- C) o grau de evolução determina o comportamento
reprodutivo.
- D) o sucesso reprodutivo pode ser garantido por
estratégias diferentes.
- E) o ambiente induz modificação na produção do número
...
O eixo de rotação da Terra apresenta uma inclinação
...
Uma lanterna funciona com três pilhas de resistência interna igual a 0,5 Ω cada, ligadas em série. Quando
...
Em uma aula prática de bioquímica, para medir a atividade catalítica da enzima catalase, foram realizados seis
ensaios independentes, nas mesmas condições, variando-se apenas a temperatura. A catalase decompõe o peróxido
de hidrogênio (H2O2), produzindo água e oxigênio. Os resultados dos ensaios estão apresentados no quadro.
Resultado
...
- D) 4
- E) 5
16 CN - 2° dia | Caderno 5 - AMARELO - 1ª Aplicação
...
- D) 13 322,5
- E) 53 290,0
MT - 2° dia | Caderno 5 - AMARELO - 1ª Aplicação
...
Preço por Preço do Tempo até
Operário hora transporte conclusão
(real) (real) (hora)
I 120 0,00 8
II 180 0,00 6
III 170 20,00 6
...
de qualquer um dos dois times vencer é sempre .
...
em linha em coluna em diagonal
Figura 1
...
médio do lado do quadrado original, de modo que OR = OM, traçar um arco de circunferência de raio
medindo OM com centro no ponto R, obtendo a Figura 4. Por último, recortar o papel ao longo do arco
...
x 2 7x
bola foi descrita pela parábola y
6 3
